...
import { HelpdeskAnimationCurves, HelpdeskAnimationDurations } from '@helpdesk/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${HelpdeskAnimationDurations.entering} ${HelpdeskAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${HelpdeskAnimationDurations.exiting} ${HelpdeskAnimationCurves.acceleration}`
                }
            }
        )
    ]
