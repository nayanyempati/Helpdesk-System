...
import { FSDocument, FSDocumentElement } from '@helpdesk/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'helpdesk-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'helpdeskFullscreen'
})
export class HelpdeskFullscreenComponent implements OnInit
{
