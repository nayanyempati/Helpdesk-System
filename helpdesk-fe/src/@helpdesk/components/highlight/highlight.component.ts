...
import { HelpdeskHighlightService } from '@helpdesk/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[helpdesk-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'helpdeskHighlight'
})
export class HelpdeskHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _helpdeskHighlightService: HelpdeskHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._helpdeskHighlightService.highlight(this.code, this.lang));
