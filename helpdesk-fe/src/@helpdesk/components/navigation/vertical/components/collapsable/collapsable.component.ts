...
@Component({
    selector       : 'helpdesk-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : helpdeskAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class HelpdeskVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'helpdesk-vertical-navigation-item-collapsed': this.isCollapsed,
            'helpdesk-vertical-navigation-item-expanded' : this.isExpanded
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._helpdeskVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._helpdeskVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._helpdeskVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._helpdeskVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: HelpdeskNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: HelpdeskNavigationItem, item: HelpdeskNavigationItem): boolean
    {
