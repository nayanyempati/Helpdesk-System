...
import { ScrollbarGeometry, ScrollbarPosition } from '@helpdesk/directives/scrollbar/scrollbar.types';

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
    selector: '[helpdeskScrollbar]',
    exportAs: 'helpdeskScrollbar'
})
export class HelpdeskScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_helpdeskScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() helpdeskScrollbar: boolean = true;
    @Input() helpdeskScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'helpdeskScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.helpdeskScrollbar = coerceBooleanProperty(changes.helpdeskScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.helpdeskScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'helpdeskScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.helpdeskScrollbarOptions.currentValue);
