...
import { HelpdeskMockApiReplyCallback } from '@helpdesk/lib/mock-api/mock-api.types';

export class HelpdeskMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: HelpdeskMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: HelpdeskMockApiReplyCallback): void
    {
        // Store the reply
