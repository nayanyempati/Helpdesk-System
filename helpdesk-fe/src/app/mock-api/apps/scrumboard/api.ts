...
import { HelpdeskMockApiService, HelpdeskMockApiUtils } from '@helpdesk/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._helpdeskMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = HelpdeskMockApiUtils.guid();
        ...
        this._helpdeskMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = HelpdeskMockApiUtils.guid();
        ...
        this._helpdeskMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = HelpdeskMockApiUtils.guid();
