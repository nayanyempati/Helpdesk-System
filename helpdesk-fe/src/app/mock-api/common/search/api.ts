...
import { HelpdeskNavigationItem, HelpdeskNavigationService } from '@helpdesk/components/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._helpdeskNavigationService.getFlatNavigation(this._defaultNavigation);
